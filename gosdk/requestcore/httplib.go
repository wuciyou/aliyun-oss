...
// Header add header item string in request.
func (b *BeegoHttpRequest) Headers(headers map[string]string) *BeegoHttpRequest {
...
func (b *BeegoHttpRequest) GetHeaderParam() http.Header {
	return b.req.Header
...
func (b *BeegoHttpRequest) getResponse() (*http.Response, error) {
	...
	} else if (b.req.Method == "POST" || b.req.Method == "PUT") && b.req.Body == nil {
		if len(b.files) > 0 {
			pr, pw := io.Pipe()
